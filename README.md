...
### 👉 https://sin1n24.github.io/AvaGotchi/

内部では [esp-web-tools](https://esphome.github.io/esp-web-tools/)（esptool-js ベース）を使い、Web Serial 経由で書き込みます。スマホ・Safari・Firefox は Web Serial 非対応のため不可です。
